...
> **当前状态**:长训练 **iter 55 / 100000** in progress,reward 从 6.81 升到 **11.99**(+76%)
...
| 指标 | iter 1 | iter 10 | iter 20 | iter 30 | iter 40 | iter 50 | iter 55 |
|---|---|---|---|---|---|---|---|
| **Mean reward** | 6.81 | 6.22 | 7.44 | 7.81 | 8.36 | 10.5 | **11.99** |
| **Episode length** | 18.55 | 17.80 | 19.94 | 21.0 | 24.0 | 28.0 | **30.43** |
| **Value loss** | 5.58 | 2.84 | 1.95 | 1.85 | 2.0 | 2.1 | 2.20 |
| **AMP loss** | 0.36 | 0.015 | 0.016 | 0.015 | 0.015 | 0.016 | 0.016 |
| **AMP grad_pen** | 0.13 | 0.05 | 0.05 | 0.05 | 0.05 | 0.05 | 0.05 |
| **AMP expert pred** | 0.34 | 0.94 | 0.93 | 0.93 | 0.93 | 0.93 | 0.93 |
| **AMP policy pred** | -0.61 | -0.94 | -0.93 | -0.93 | -0.93 | -0.93 | -0.93 |
| **tracking_lin_vel** | 0.39 | 0.40 | 0.43 | 0.45 | 0.50 | 0.60 | **0.75** |
| **alive** | 0.07 | 0.08 | 0.08 | 0.09 | 0.10 | 0.11 | **0.12** |
| **collision** | -0.008 | -0.009 | -0.013 | -0.05 | -0.08 | -0.10 | -0.125 |
| **base_height** | -0.014 | -0.015 | -0.017 | -0.03 | -0.05 | -0.06 | -0.06 |
